import { t as L, m as O } from './playground.astro_astro_type_script_index_0_lang.4Bgy4eQi.js'
 ...
 *-----------------------------------------------------------------------------*/ var I = Object.defineProperty,
  ...
  K = (e, t, i, o) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let n of M(t)) !R.call(e, n) && n !== i && I(e, n, { get: () => t[n], enumerable: !(o = N(t, n)) || o.enumerable })
    return e
  },
...
var m = class {
  ...
  W = class extends m {
    ...
    async _doValidate(e) {
      ...
      const i = [],
        { noSyntaxValidation: o, noSemanticValidation: n, noSuggestionDiagnostics: c } = this._defaults.getDiagnosticsOptions()
      ...
      const s = u
          ...
          .filter(g => (this._defaults.getDiagnosticsOptions().diagnosticCodesToIgnore || []).indexOf(g.code) === -1),
        l = s
  ...
  j = class x extends m {
        ...
        : {
            suggestions: d.entries.map(f => {
              ...
              if (f.replacementSpan) {
                const k = t.getPositionAt(f.replacementSpan.start),
                  v = t.getPositionAt(f.replacementSpan.start + f.replacementSpan.length)
              ...
              return (
                f.kindModifiers !== void 0 &&
                  ...
                  S.push(a.languages.CompletionItemTag.Deprecated),
                {
                  uri: s,
                  position: i,
                  offset: l,
    ...
    async resolveCompletionItem(t, i) {
      const o = t,
        ...
        c = o.position,
        u = o.offset,
        l = await (await this._worker(n)).getCompletionEntryDetails(n.toString(), u, o.label)
      return l
        ? {
            uri: n,
            position: c,
            ...
            documentation: { value: x.createDocumentationString(l) }
          }
        : o
    }
...
var B = class T extends m {
    ...
    async provideSignatureHelp(t, i, o, n) {
      ...
      if (t.isDisposed()) return
      const l = await s.getSignatureHelpItems(c.toString(), u, { triggerReason: T._toSignatureHelpTriggerReason(n) })
      if (!l || t.isDisposed()) return
      const g = { activeSignature: l.selectedItemIndex, activeParameter: l.argumentIndex, signatures: [] }
      return (
        l.items.forEach(d => {
          ...
          ;(h.documentation = { value: _(d.documentation) }),
            ...
            d.parameters.forEach((f, w, S) => {
              const k = _(f.displayParts),
                v = { label: k, documentation: { value: _(f.documentation) } }
  ...
  z = class extends m {
    ...
    async provideDefinition(e, t, i) {
      ...
      if (
        !u ||
        e.isDisposed() ||
        (await this._libFiles.fetchLibFilesIfNecessary(u.map(l => a.Uri.parse(l.fileName))), e.isDisposed())
      )
        return
      const s = []
      for (let l of u) {
  ...
  G = class extends m {
    ...
    async provideReferences(e, t, i, o) {
      ...
      if (
        !s ||
        e.isDisposed() ||
        (await this._libFiles.fetchLibFilesIfNecessary(s.map(g => a.Uri.parse(g.fileName))), e.isDisposed())
      )
        return
      const l = []
      for (let g of s) {
  ...
  X = class extends y {
    async provideCodeActions(e, t, i, o) {
      ...
      return !d || e.isDisposed()
        ...
        : {
            actions: d
              .filter(f => f.changes.filter(w => w.isNewFile).length === 0)
              .map(f => this._tsCodeFixActionToMonacoCodeAction(e, i, f)),
            dispose: () => {}
          }
    }
    _tsCodeFixActionToMonacoCodeAction(e, t, i) {
      ...
      for (const c of i.changes)
        for (const u of c.textChanges)
          o.push({ resource: e.uri, versionId: void 0, textEdit: { range: this._textSpanToRange(e, u.span), text: u.newText } })
      return { title: i.description, edit: { edits: o }, diagnostics: t.markers, kind: 'quickfix' }
    }
  },
  Y = class extends m {
    constructor(e, t) {
    ...
    async provideRenameEdits(e, t, i, o) {
      ...
      if (l.canRename === !1) return { edits: [], rejectReason: l.localizedErrorMessage }
      ...
      for (const h of g) {
        ...
        if (f) d.push({ resource: f.uri, versionId: void 0, textEdit: { range: this._textSpanToRange(f, h.textSpan), text: i } })
...
function P(e, t) {
  ...
  function u() {
    ...
    ee(i),
      s.completionItems && i.push(a.languages.registerCompletionItemProvider(t, new j(n))),
      s.signatureHelp && i.push(a.languages.registerSignatureHelpProvider(t, new B(n))),
      s.hovers && i.push(a.languages.registerHoverProvider(t, new U(n))),
      s.documentHighlights && i.push(a.languages.registerDocumentHighlightProvider(t, new $(n))),
      s.definitions && i.push(a.languages.registerDefinitionProvider(t, new z(c, n))),
      s.references && i.push(a.languages.registerReferenceProvider(t, new G(c, n))),
      s.documentSymbols && i.push(a.languages.registerDocumentSymbolProvider(t, new J(n))),
      s.rename && i.push(a.languages.registerRenameProvider(t, new Y(c, n))),
      s.documentRangeFormattingEdits && i.push(a.languages.registerDocumentRangeFormattingEditProvider(t, new Q(n))),
      s.onTypeFormattingEdits && i.push(a.languages.registerOnTypeFormattingEditProvider(t, new q(n))),
      s.codeActions && i.push(a.languages.registerCodeActionProvider(t, new X(n))),
      s.inlayHints && i.push(a.languages.registerInlayHintsProvider(t, new Z(n))),
